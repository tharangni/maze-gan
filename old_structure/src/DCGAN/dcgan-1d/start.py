...
def start():
    ...
    parser.add_argument('--mx', help='No. columns in maze', type=int, default=6)
    parser.add_argument('--my', help='No. rows in maze', type=int, default=6)
